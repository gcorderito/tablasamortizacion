...
def calcular_amortizacion_aleman(monto, tasa, n, frecuencia, diapago, fechaprimerpago):
    ...
    for periodo in range(1, n + 1):
        ...
        c = amortizacion + intereses
        #c = saldo_insoluto / n + (i * saldo_insoluto)

        # Calcular la amortización
        #amortizacion = c - (saldo_insoluto / n)
        ...
        tabla_amortizacion.append({
            ...
            "Fecha Mínima" : str(fechaminima),
            "Fecha Máxima" : str(fechamaxima),
